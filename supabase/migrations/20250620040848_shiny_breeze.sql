/*
  ...
  1. Problem
    ...
    - Complex policies with subqueries create circular dependencies

  2. Solution
    - Drop the problematic memories_with_likes view
...
-- First, drop the problematic view that's causing recursion
