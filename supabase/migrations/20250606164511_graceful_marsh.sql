...
-- Ensure users table exists (should be handled by Supabase Auth)
-- This is just to make sure we can reference it
...
-- Create or update memories table
...
BEGIN
  ...
  -- Add foreign key for memories.board_id if it doesn't exist
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
