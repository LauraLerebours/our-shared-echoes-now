/*
  # Add toggle_memory_like function for likes functionality

  1. New Function
    - `toggle_memory_like` - Function to toggle a memory's like status
    - Handles both liking and unliking a memory
    - Returns updated like count and status
    - Uses SECURITY DEFINER to bypass RLS issues

  2. Security
    - Function uses SECURITY DEFINER to ensure it works regardless of RLS
