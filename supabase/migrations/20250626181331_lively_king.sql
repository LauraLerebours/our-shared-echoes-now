/*
  # Add Carousel Memory Type

  1. New Features
    - Add 'carousel' memory type to support multiple photos/videos in a single memory
    - Create memory_media_items table to store carousel items
    - Update constraints and policies to support the new memory type

  2. Changes
    - Update memory_type check constraint to include 'carousel'
    - Create memory_media_items table with proper foreign keys
    - Add RLS policies for the new table
    - Create helper functions for accessing carousel items
*/
...
-- Update the functions that depend on memories_with_likes view
