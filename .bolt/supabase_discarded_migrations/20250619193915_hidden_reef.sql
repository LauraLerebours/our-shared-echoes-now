/*
  ...
  1. New Tables
    - `moderation_logs` - Store moderation results for all content
    - Add moderation fields to existing tables

  2. Security
    - Enable RLS on moderation_logs table
    - Add policies for moderation access

  3. Functions
    - Add moderation logging functions
*/
...
WHERE m.moderation_status = 'approved'; -- Only show approved content
