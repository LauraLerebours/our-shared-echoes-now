/*
  ...
  2. Changes
    - Add board_id to memories table
    - Set up RLS policies for board access

  3. Security
    - Enable RLS on boards table
    - Add policies for board access via codes
*/
...
CREATE POLICY "Anyone can view boards with access code"
...
-- Update memories policies to check board access
